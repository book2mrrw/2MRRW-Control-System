...
const vaultItemUpdateSchema = z.object({
  ...
  shelfStoragePath: z.string().nullable().optional(),
  shelfUrl: z.string().nullable().optional(),
  contentStoragePath: z.string().nullable().optional(),
  contentUrl: z.string().nullable().optional(),
  isDropItem: z.boolean().optional(),
  dropType: z.enum(["surprise", "promo", "limited"]).nullable().optional(),
  expiresAt: z.string().nullable().optional(),
  tierVisibility: z.array(z.string()).optional(),
