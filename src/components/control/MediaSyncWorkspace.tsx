...
export function MediaLibrary({
  ...
  const { connected: syncConnected } = useMediaSync(handleMediaSyncEvent);
    ...
    <div className="media-control-room">
      ...
      <div className="media-sync-section-scroll">
        {activeSection === "singles" ? (
          <ReleaseManagementSection sectionTitle="Singles" catalog={catalog} releases={releases} filter={singlesFilter} syncRows={syncRows} syncConnected={syncConnected} onEdit={setEditReleaseId} onOpenRelease={onOpenRelease} onUploadComplete={handleUploadComplete} actions={actions} />
        ) : null}
        {activeSection === "albums_eps" ? (
          <ReleaseManagementSection sectionTitle="Albums & EPs" catalog={catalog} releases={releases} filter={albumsFilter} syncRows={syncRows} syncConnected={syncConnected} onEdit={setEditReleaseId} onOpenRelease={onOpenRelease} onUploadComplete={handleUploadComplete} actions={actions} />
        ) : null}
        {activeSection === "features" ? (
          <ReleaseManagementSection sectionTitle="Features" catalog={catalog} releases={releases} filter={featuresFilter} syncRows={syncRows} syncConnected={syncConnected} onEdit={setEditReleaseId} onOpenRelease={onOpenRelease} onUploadComplete={handleUploadComplete} actions={actions} />
        ) : null}
